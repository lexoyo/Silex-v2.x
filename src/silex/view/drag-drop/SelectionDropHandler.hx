 ...
 * This class uses draggable and adds the behavior of moving the layers and components.
 * use attribute like this: data-dropzones-class-name="Layer" data-dropzones-class-name="silex-view"
